...
class BackendClass(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.faces_train, self.faces_test, self.first_image_size = store_dataset_method_one(self.dataset_dir)
        self.train_faces_matrix, self.train_faces_labels ,self.PCA_eigen_faces, self.PCA_weights = train_pca(self.faces_train)
        ...
        self.detection_models = upload_cascade_adaboost("new_model_15_window")
    ...
    def apply_PCA(self):
        ...
        best_match_subject, best_match_subject_distance, best_match_indx = (
            recognise_face(test_image, self.first_image_size, 
                                self.train_faces_matrix, self.train_faces_labels, 
                                self.PCA_weights, self.PCA_eigen_faces, self.face_recognition_threshold)
        )
